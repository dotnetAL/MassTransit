...
MassTransit v10 adds support for .NET 10 while maintaining compatibility with previous .NET versions. This version includes updated dependencies and optimizations for the latest .NET runtime.

### Target Framework Support

MassTransit v10 supports the following target frameworks:
- .NET Standard 2.0
- .NET 8.0
- .NET 10.0  
...
All NuGet packages have been updated to support .NET 10.0, providing access to the latest performance improvements and features available in the .NET 10 runtime.

### Migration Notes

Upgrading from previous versions to v10 should be seamless for most applications. Simply update your project target framework to `net10.0` and update your MassTransit package references to the latest v10 versions.
